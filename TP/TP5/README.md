...
Les fichiers [`.eslintrc.json`](base/.eslintrc.json) et [`.prettierrc`](base/.prettierrc) sont fournis dans le dossier `TP5/base`. Exécuter la commande suivante pour installe les dépendances :
